...
<?php
    ...
    $sql = "SELECT id_diario, horario_aula, nome_aula, nome_professor, numero_sala, duracao_aula FROM diario INNER JOIN professor on fk_professor = id_professor INNER JOIN aula on fk_aula = id_aula;";
    ...
    if ($result -> num_rows > 0) {
        ...
        while($row = $result -> fetch_assoc()){
            echo "<tr>
                    ...
                    <td>
                        <a href='update.php'><button>Editar</button></a>
                        <button>
                            Excluir
                        </button>
                    </td>
